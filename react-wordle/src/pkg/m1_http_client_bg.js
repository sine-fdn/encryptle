import * as wasm from './m1_http_client_bg.wasm';
...
function __wbg_adapter_30(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha6687a262fd9ab20(arg0, arg1, addHeapObject(arg2));
}
...
*/
export function compute(url, plaintext_metadata, program, input) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(plaintext_metadata, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    _assertClass(program, MpcProgram);
    var ptr2 = program.ptr;
    program.ptr = 0;
    _assertClass(input, MpcData);
    var ptr3 = input.ptr;
    input.ptr = 0;
    const ret = wasm.compute(ptr0, len0, ptr1, len1, ptr2, ptr3);
...
function __wbg_adapter_98(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__hb9eadd772fb4ea4e(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class MpcData {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MpcData.prototype);
        obj.ptr = ptr;
    ...
    * @returns {MpcData}
    */
    static from_string(program, input) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(program, MpcProgram);
            const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.mpcdata_from_string(retptr, program.ptr, ptr0, len0);
    ...
    * @returns {MpcData}
    */
    static from_object(program, literal) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(program, MpcProgram);
            wasm.mpcdata_from_object(retptr, program.ptr, addHeapObject(literal));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    to_literal_string() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mpcdata_to_literal_string(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    to_literal() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mpcdata_to_literal(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class MpcProgram {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MpcProgram.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mpcprogram_free(ptr);
    }
    /**
    * @param {string} source_code
    * @param {string} function_name
    */
    constructor(source_code, function_name) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            ...
            const len1 = WASM_VECTOR_LEN;
            wasm.mpcprogram_new(retptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    report_gates() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mpcprogram_report_gates(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export function __wbg_mpcdata_new(arg0) {
    const ret = MpcData.__wrap(arg0);
...
export function __wbg_fetch_418022d5305701bc(arg0) {
    const ret = fetch(getObject(arg0));
    return addHeapObject(ret);
};

export function __wbg_new_7dccd0021b1c5f96() { return handleError(function () {
    const ret = new Headers();
    return addHeapObject(ret);
}, arguments) };

export function __wbg_append_17f7a2e57f2ff190() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
...
export function __wbg_url_125d6252e330b0a6(arg0, arg1) {
...
export function __wbg_status_a89019a1cc360813(arg0) {
    const ret = getObject(arg0).status;
    return ret;
};

export function __wbg_headers_9dc27fdefb9df965(arg0) {
...
export function __wbg_text_41a400f624a836b7() { return handleError(function (arg0) {
    const ret = getObject(arg0).text();
    return addHeapObject(ret);
}, arguments) };

export function __wbg_fetch_34330dbf7f05e86e(arg0, arg1) {
    const ret = getObject(arg0).fetch(getObject(arg1));
    return addHeapObject(ret);
};

export function __wbg_newwithstrandinit_db4660b2cd7a5d77() { return handleError(function (arg0, arg1, arg2) {
